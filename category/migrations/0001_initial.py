    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district_img', models.CharField(blank=True, max_length=500, null=True)),
                ('district_desc', models.TextField(blank=True, null=True)),
                ('district_lat', models.CharField(blank=True, max_length=100, null=True)),
                ('district_lon', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place_feature', models.CharField(blank=True, max_length=255, null=True)),
                ('place_keyword_cd', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('place_lat', models.DecimalField(blank=True, decimal_places=7, max_digits=10, null=True)),
                ('place_lon', models.DecimalField(blank=True, decimal_places=7, max_digits=10, null=True)),
            ],
            options={
                'db_table': 'place_tb',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place_address', models.CharField(blank=True, max_length=50, null=True)),
                ('review_text', models.TextField(blank=True, null=True)),
                ('review_photo', models.TextField(blank=True, null=True)),
                ('review_date', models.DateField(blank=True, null=True)),
                ('review_sentiment', models.IntegerField(blank=True, null=True)),
